          ...
          >
            ...
            />
            {
              lines.map((line, index) => 
                <Line dot={this.setLastDot} filter="url(#drop-shadow)" type="monotone" dataKey={!this.state.toggledLines.find(selectedLine => selectedLine === line) ?line : ""} name={line} key={line} stroke={colors[index % colors.length]} />  
              )
            }
          </LineChart>
        </ResponsiveContainer>
