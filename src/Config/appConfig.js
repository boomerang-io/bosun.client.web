...
export const TEST_PRODUCT_STANDALONE =
...
export const PRODUCT_STANDALONE = (process.env.PRODUCT_STANDALONE === "true" || TEST_PRODUCT_STANDALONE) ?? false;
console.log(process.env, window._SERVER_DATA, PRODUCT_STANDALONE, "PROCESS ENV - APP CONFIG");
// TODO
export const ROUTES = {};
