...
const toggledItems: any = [];
const lastDots: any = [];
describe("CustomLegend --- Snapshot", () => {
    it("Capturing Snapshot of CustomLegend", async () => {
        // @ts-expect-error ts-migrate(17004) FIXME: Cannot use JSX unless the '--jsx' flag is provided... Remove this comment to see the full error message
        const { baseElement } = (global as any).rtlRouterRender(<CustomLegend payload={payload} toggleItem={toggleItem} toggledItems={toggledItems} lastDots={lastDots}/>);
